...
import com.sws.saml.core.SAMLUserDetailsServiceImpl;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter implements InitializingBean, DisposableBean {
    ...
    private String idpKeycloakMetadataURL = "http://localhost:8080/auth/realms/MyDemo/protocol/saml/descriptor";
    ...
    public KeyManager keyManager() {
        ...
        Resource storeFile = loader
                .getResource("classpath:/saml/hello.jks");
    ...
    public ExtendedMetadataDelegate keycloakExtendedMetadataProvider()
            throws MetadataProviderException {
//        String idpKeycloakMetadataURL = "http://localhost:8080/auth/realms/madhyam/protocol/saml/descriptor";
        HTTPMetadataProvider httpMetadataProvider = new HTTPMetadataProvider(
    ...
    public MetadataGenerator metadataGenerator() {
        ...
        metadataGenerator.setEntityId("demo-saml");
